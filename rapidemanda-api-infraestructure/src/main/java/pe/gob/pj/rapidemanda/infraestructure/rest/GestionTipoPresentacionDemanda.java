...
@RestController
@RequestMapping(value = "tipos-presentacion-demanda", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
public interface GestionTipoPresentacionDemanda extends Base {

    @GetMapping
    ResponseEntity<GlobalResponse> consultarTiposPresentacionDemanda(
            ...
            @RequestHeader(name = "formato-respuesta", defaultValue = "json", required = false) String formatoRespuesta);
}