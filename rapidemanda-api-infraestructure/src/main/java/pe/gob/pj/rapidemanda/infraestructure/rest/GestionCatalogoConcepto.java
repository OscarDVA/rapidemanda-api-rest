...
@RestController
@RequestMapping(value = "catalogo-conceptos", produces = { MediaType.APPLICATION_JSON_VALUE,
		MediaType.APPLICATION_XML_VALUE })
public interface GestionCatalogoConcepto extends Base {

	@GetMapping
	ResponseEntity<GlobalResponse> consultarCatalogoConceptos(
