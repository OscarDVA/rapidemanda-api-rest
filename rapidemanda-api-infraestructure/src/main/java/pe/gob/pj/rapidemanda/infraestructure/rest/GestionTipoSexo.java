...
@RestController
@RequestMapping(value = "tipos-sexo", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
public interface GestionTipoSexo extends Base {

    @GetMapping
    ResponseEntity<GlobalResponse> consultarTiposSexo(
