...
@RestController
@RequestMapping(value = "tipos-regimen", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
public interface GestionTipoRegimen extends Base {

    @GetMapping
    ResponseEntity<GlobalResponse> consultarTiposRegimen(
