...
public class GestionTipoAnexoController implements GestionTipoAnexo, Serializable {

	private static final long serialVersionUID = 1L;

	@Qualifier("gestionTipoAnexoUseCasePort")
	final GestionTipoAnexoUseCasePort gestionTipoAnexoUseCasePort;

	@Override
	public ResponseEntity<GlobalResponse> consultarTiposAnexo(String cuo, String ips, String usuauth, String uri,
		...
		try {
			...
			res.setData(gestionTipoAnexoUseCasePort.buscarTipoAnexos(cuo));
			...
			handleException(cuo,
					new ErrorException(Errors.ERROR_INESPERADO.getCodigo(), String
							.format(Errors.ERROR_INESPERADO.getNombre(), Proceso.TIPO_ANEXO_CONSULTAR.getNombre()),
