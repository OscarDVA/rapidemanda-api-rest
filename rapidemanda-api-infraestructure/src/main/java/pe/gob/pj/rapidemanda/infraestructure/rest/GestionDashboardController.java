...
public class GestionDashboardController implements GestionDashboard, Serializable {
    ...
    @Qualifier("gestionDashboardUseCasePort")
    ...
    @Override
    public ResponseEntity<GlobalResponse> consultarListas(String cuo, String ips, String usuauth, String uri,
        ...
        try {
            res.setCodigo(Errors.OPERACION_EXITOSA.getCodigo());
            res.setDescripcion(Errors.OPERACION_EXITOSA.getNombre());
            res.setData(gestionDashboardUseCasePort.obtenerListas(cuo, limite));
        } catch (ErrorException e) {
            handleException(cuo, e, res);
        } catch (Exception e) {
            handleException(cuo,
