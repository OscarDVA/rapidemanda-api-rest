...
public class GestionTipoViaController implements GestionTipoVia, Serializable {

    private static final long serialVersionUID = 1L;

    @Qualifier("gestionTipoViaUseCasePort")
    final GestionTipoViaUseCasePort gestionTipoViaUseCasePort;

    @Override
    public ResponseEntity<GlobalResponse> consultarTiposVia(String cuo, String ips, String usuauth, String uri,
        ...
        try {
            ...
            res.setData(gestionTipoViaUseCasePort.buscarTiposVia(cuo));
            ...
            handleException(cuo,
                    new ErrorException(Errors.ERROR_INESPERADO.getCodigo(), String
                            .format(Errors.ERROR_INESPERADO.getNombre(), Proceso.TIPO_VIA_CONSULTAR.getNombre()),
