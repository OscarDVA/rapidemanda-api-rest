...
@RestController
@RequestMapping(value = "tipos-documento", produces = { MediaType.APPLICATION_JSON_VALUE,
        MediaType.APPLICATION_XML_VALUE })
public interface GestionTipoDocumentoPersona extends Base {

    @GetMapping
    ResponseEntity<GlobalResponse> consultarTiposDocumentoPersona(
