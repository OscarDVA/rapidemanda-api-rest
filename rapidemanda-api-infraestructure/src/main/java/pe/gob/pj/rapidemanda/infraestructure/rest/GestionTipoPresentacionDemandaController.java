...
public class GestionTipoPresentacionDemandaController implements GestionTipoPresentacionDemanda, Serializable {

    private static final long serialVersionUID = 1L;

    @Qualifier("gestionTipoPresentacionDemandaUseCasePort")
    final GestionTipoPresentacionDemandaUseCasePort gestionTipoPresentacionDemandaUseCasePort;

    @Override
    public ResponseEntity<GlobalResponse> consultarTiposPresentacionDemanda(String cuo, String ips, String usuauth,
        ...
        try {
            ...
            res.setData(gestionTipoPresentacionDemandaUseCasePort.buscarTiposPresentacionDemanda(cuo));
            ...
            handleException(cuo, new ErrorException(Errors.ERROR_INESPERADO.getCodigo(),
                    String.format(Errors.ERROR_INESPERADO.getNombre(),
                            Proceso.TIPO_PRESENTACION_DEMANDA_CONSULTAR.getNombre()),
