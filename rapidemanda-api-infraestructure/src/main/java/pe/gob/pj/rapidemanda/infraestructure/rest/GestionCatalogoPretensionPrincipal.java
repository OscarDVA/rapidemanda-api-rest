...
@RestController
@RequestMapping(value = "catalogo-pretension-principal", produces = { MediaType.APPLICATION_JSON_VALUE,
		MediaType.APPLICATION_XML_VALUE })
public interface GestionCatalogoPretensionPrincipal extends Base {

	@GetMapping
	ResponseEntity<GlobalResponse> consultarCatalogoPretensionPrincipales(
			...
			@RequestParam(name = "id_petitorio", required = false) Integer petitorioId);
}