...
public class GestionPerfilController implements GestionPerfil, Serializable {

	private static final long serialVersionUID = 1L;

	@Qualifier("gestionPerfilUseCasePort")
	final GestionPerfilUseCasePort gestionPerfilUseCasePort;

	@Override
	public ResponseEntity<GlobalResponse> consultarPerfiles(String cuo, String ips, String usuauth, String uri,
		...
		try {
			...
			res.setData(gestionPerfilUseCasePort.buscarPerfiles(cuo));
			...
			handleException(cuo,
					new ErrorException(Errors.ERROR_INESPERADO.getCodigo(),
							String.format(Errors.ERROR_INESPERADO.getNombre(), Proceso.PERFIL_CONSULTAR.getNombre()),
